...
Original file is located at
    https://colab.research.google.com/drive/1KU__tPDPROsN7fFAoclHjUO2rqdzHo4c
"""
...
#	return (np.load('./data/svhn/train.npy')/255. , np.load('./data/svhn/train_label.npy'))
	return (np.squeeze(np.load('./data/svhn/test.npy')[:self.no_images]/255.) , np.load('./data/svhn/test_label.npy')[:self.no_images])
